...
export default function CookAllergies() {
  ...
  if (user?.role && user.role !== "cook" && user.role !== "admin") {
  ...
  return (
    <section className="page">
      <header className="auth-header">
        <h2>Аллергены кухни</h2>
        <p>Создавайте и поддерживайте справочник аллергенов.</p>
      </header>
